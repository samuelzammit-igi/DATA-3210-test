create view "dbt_szammit"."stg_journal_pairs__dbt_tmp" as
    with

journal_pair as (
    select * from "IGI_PROD_DW"."dbt_szammit"."scd_journal_pair" where _valid_to is null
),
...
stg_division as (
    select * from "IGI_PROD_DW"."dbt_szammit"."stg_division"
),

stg_subdivision as (
    select * from "IGI_PROD_DW"."dbt_szammit"."stg_subdivision"
),
