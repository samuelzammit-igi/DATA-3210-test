create view "dbt_szammit"."dmn_claim_amounts__dbt_tmp" as
    

with
Inward_claims as (
    select * from "IGI_PROD_DW"."dbt_szammit"."stg_inward_claims_amounts"
),

Outward_claims as (
    select * from "IGI_PROD_DW"."dbt_szammit"."stg_outward_claims_amounts"
),

/*policy as (
    select * from "IGI_PROD_DW"."dbt_szammit"."dmn_policy"
),*/
