create view "dbt_szammit"."stg_type_of_monetary_amount__dbt_tmp" as
    

with

toma as (
    select * from "IGI_PROD_DW"."dbt_szammit"."scd_type_of_monetary_amount" where _valid_to is null
),
